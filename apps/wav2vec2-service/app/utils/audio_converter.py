...
class AudioConverter:
    ...
    def convert_to_wav(cls, video_path: str, target_sample_rate: int = 16000) -> str:
        ...
        - NO volume normalization to avoid artifacts
        
        Args:
            video_path: Path to video file (MKV, MP4, AVI, MOV, WEBM)
        ...
        try:
            ...
            ffmpeg_cmd = [
                ...
                '-ar', str(target_sample_rate),  # Sample rate (16kHz optimal for transcription)
                '-ac', '1',                 # Mono channel (better for ASR)
            ...
            if result.returncode != 0:
                ...
                # Simple fallback for compatibility issues
